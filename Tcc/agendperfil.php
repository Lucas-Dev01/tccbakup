...
<html>
   <head>
      ...
      <link rel="stylesheet" href="./assets/css/AcessoFunc.css">
               ...
               <div class="container">
                  ...
                  <div class="collapse navbar-collapse" id="navbarResponsive-1">
                     <ul class="navbar-nav ms-auto text-uppercase">
                        ...
                        <li class="nav-item"><a class="nav-link" href="SelecBarb1.html">Agendar</a></li>
                        <li class="nav-item"><a class="nav-link" href="TrocarPerfil.php">Alterar Dados</a></li>
                     </ul>
                     <ul class="navbar-nav">
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12 text-center">
                  <h2 class="text-uppercase section-heading">Agendamentos!</h2>
                  <h3 class="text-muted section-subheading"><strong>Aqui esta seus agendamentos realizados</strong></h3>
               </div>
            </div>
         </div>
            ...
            <div class="card" id="TableSorterCard">
               <div class="card-header py-3">
                  <div class="row table-topper align-items-center">
                     ...
                     <!-- <div class="col-12 col-sm-7 col-md-6 text-end" style="margin: 0px;padding: 5px 15px;"><input type="text" placeholder="Digite o ID do Usuário"><button class="btn btn-primary btn-sm reset" type="button" style="margin: 2px;background: rgb(52, 58, 64);border-color: rgb(52, 58, 64);">Pesquisar Agendamento</button>
                      <form name="deletar" action="php/Deletaragend.php" method="post">  
                     <input id="inputbusca" type="text" name="deletar" placeholder="Digite o ID do Usuário">  <button class="btn btn-primary btn-sm reset" type="submit" onclick="alerta(); style="margin: 2px;background: rgb(52, 58, 64);border-color: rgb(52, 58, 64);">Deletar Agendamento</button>
                 </form> -->
                 <!-- <div class="busca">
	<form name="deletar" action="assets/php/DeletUsu.php" method="post">
		<input id="inputbusca" type="text" name="deletar" placeholder="Digite o ID do Agendamento">
                     ...
                     <div class="table-responsive">
                        <table class="table table-striped table tablesorter" id="ipi-table">
                           ...
                           <tbody class="text-center">
                              ...
                              $pdo = Banco::conectar();
                              $sql = 'SELECT * FROM agendamentos WHERE idUser="'.$id.'" ORDER BY id_agend DESC';
